---
name: zod-hono-openapi
description: An extended Hono class that supports OpenAPI. With it, you can validate values and types using Zod and generate OpenAPI Swagger documentation. This is preferred for building APIs with Hono.
---
